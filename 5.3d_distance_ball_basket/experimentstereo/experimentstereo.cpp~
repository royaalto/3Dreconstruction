...
int main() {
    ...
    Mat rotation = (Mat_<double>(3,3) << 9.9754776061021022e-01, -5.9205705742467113e-02, 3.7324920751303003e-02, 6.4385851621446319e-02, 9.8537797903151381e-01, -1.5774885277158313e-01, -2.7439522819024228e-02, 1.5976521163039814e-01, 9.8677360612257881e-01);
    Mat translation = (Mat_<double>(3,1) << 1.5614813663151048e-01, 8.8679693107031650e+00, -1.9231720060438612e-01);
    Mat Identity = (Mat_<double>(3,3) << 1, 0, 0, 0, 1, 0, 0, 0, 1);
    Mat zeros = (Mat_<double>(3,1) << 0, 0, 0);
    Mat E0;
    Mat E1;
    ...
    //ax+by+cz+d=0
    Point3f A(-6.0112505, -6.0138416, 30.712807);
    Point3f B(0.37583232, -4.4044065, 30.423258);
    Point3f C(-4.263803, -0.69066775, 29.536028);
    double a;
    double b;
    double c;
    double d;
...
//the center of the trash bin
    Point3f trash(-2.3902547, -4.668714, 30.347767);
